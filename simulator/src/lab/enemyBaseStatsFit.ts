...
import type { BattleInput, FighterInput, SimulatorConfig, StatBlock, TroopStatsCatalogue, UnitType } from "../types";
...
function printUsage(): void {
  console.log(`Usage: npx tsx src/lab/enemyBaseStatsFit.ts [options]
